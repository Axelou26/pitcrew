 ...
 */
final class Version20250725093500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD shares_counter INT DEFAULT 0 NOT NULL, DROP reaction_counts');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recruiter_applicant (recruiter_id INT NOT NULL, applicant_id INT NOT NULL, INDEX IDX_B2E376EB156BE243 (recruiter_id), INDEX IDX_B2E376EB97139001 (applicant_id), PRIMARY KEY(recruiter_id, applicant_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE post ADD reaction_counts JSON DEFAULT NULL, DROP shares_counter');
