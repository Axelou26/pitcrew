 ...
 */
final class Version20250325104936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application ADD cv_url VARCHAR(255) DEFAULT NULL, CHANGE cover_letter cover_letter LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE status status VARCHAR(255) NOT NULL, CHANGE recommendation_letter_filename cv_s3_key VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE job_application ADD resume_s3_key VARCHAR(255) DEFAULT NULL, ADD resume_url VARCHAR(255) DEFAULT NULL, ADD documents_s3_keys JSON NOT NULL, ADD documents_urls JSON NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application ADD recommendation_letter_filename VARCHAR(255) DEFAULT NULL, DROP cv_s3_key, DROP cv_url, CHANGE cover_letter cover_letter LONGTEXT DEFAULT NULL, CHANGE status status VARCHAR(20) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE job_application DROP resume_s3_key, DROP resume_url, DROP documents_s3_keys, DROP documents_urls');
    }
}
