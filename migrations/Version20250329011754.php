 ...
 */
final class Version20250329011754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE post_share ADD CONSTRAINT FK_781D11B56A5E0F9B FOREIGN KEY (shared_post_id) REFERENCES post (id)
        SQL);
        $this->addSql(<<<'SQL'
