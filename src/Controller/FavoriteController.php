...
class FavoriteController extends AbstractController
{
    ...
    public function index(FavoriteRepository $favoriteRepository): Response
    {
        ...
        $template    = $isRecruiter
            ? 'favorite/recruiter_favorites.html.twig'
            : 'favorite/candidate_favorites.html.twig';
        $favorites = $isRecruiter
            ? $favoriteRepository->findBy(['user' => $user, 'type' => Favorite::TYPE_CANDIDATE])
            : $favoriteRepository->findBy(['user' => $user, 'type' => Favorite::TYPE_JOB_OFFER]);
