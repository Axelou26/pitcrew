...
class ExperienceScoreCalculator extends BaseScoreCalculator
{
    ...
    public function calculate(Applicant $applicant, JobOffer $jobOffer): array
    {
        ...
        return [
            'score' => $this->calculateWeightedScore($totalScore, 100, self::WEIGHT),
            'maxScore' => $this->calculateMaxWeightedScore(100, self::WEIGHT),
            'details' => [],
