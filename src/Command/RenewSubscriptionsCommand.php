    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            foreach ($subscriptionsToRenew as $subscription) {
                $io->text(sprintf('Traitement de l\'abonnement #%d pour %s', 
                    $subscription->getId(), 
                ...
                try {
                    ...
                    $io->error(sprintf('Erreur lors du renouvellement de l\'abonnement #%d : %s', 
                        $subscription->getId(), 
                        $e->getMessage()
                    ));
                    $failedCount++;
            ...
            $io->success(sprintf('Renouvellement terminé : %d abonnements renouvelés, %d échecs', 
                $renewedCount, 
                $failedCount
            ));
